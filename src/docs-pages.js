...
export const docsPages = [
  ...
  { path: "/docs/getting-started/whats-new", sectionId: "whats-new", category: "Get started", title: "What's new in v0.5", description: "Explore the v0.5 dev preview: accordion, skeletons, token exports, TypeScript declarations, adapter parity, and stronger release validation." },

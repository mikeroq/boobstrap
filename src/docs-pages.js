export const docsPages = [
  ...
  { path: "/docs/components/tables", sectionId: "tables", category: "Components", title: "Tables and pagination", description: "Build semantic data tables with captions, headers, footers, composable visual styles, responsive and sticky overflow, sortable controls, empty states, and accessible pagination." },

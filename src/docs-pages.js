export const docsPages = [
  ...
  { path: "/docs/components/navbar", sectionId: "navbar", category: "Components", title: "Header and navbar", description: "Build a semantic, responsive header with Boobstrap brand, navigation link, and menu-toggle components." },

export const docsPages = [
  ...
  { path: "/docs/components/navbar", sectionId: "navbar", category: "Components", title: "Navigation", description: "Build semantic headers, grouped sidebars, breadcrumb trails, and previous/next page navigation with Boobstrap components." },

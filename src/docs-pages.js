...
export const docsPages = [
  // 01 Get started (Logical onboarding order)
  ...
  { path: "/docs/getting-started/compiler", sectionId: "compiler", category: "Get started", title: "Custom CSS Compiler", description: "Tree-shake components, customize token overrides, palettes, radii, breakpoints, and inline static CSS with the Boobstrap compiler and CLI." },
  ...
  { path: "/docs/components/forms/checkbox", sectionId: "form-checkbox", category: "Forms", title: "Checkbox", description: "Build accessible checkboxes, groups, descriptions, inline options, indeterminate states, and validation feedback." },
  ...
  { path: "/docs/components/forms/inputs", sectionId: "form-inputs", category: "Forms", title: "Inputs", description: "Build labeled text controls with help text, validation feedback, disabled and read-only states, and three sizes." },
  ...
  { path: "/docs/components/forms/radio", sectionId: "form-radio", category: "Forms", title: "Radio", description: "Build mutually exclusive single-select radio groups, descriptions, inline options, and validation feedback." },
  ...
  { path: "/docs/components/forms/switch", sectionId: "form-switch", category: "Forms", title: "Switch", description: "Build accessible on/off toggle switches, descriptions, groups, disabled states, and validation feedback." },
  { path: "/docs/components/forms/textarea", sectionId: "form-textarea", category: "Forms", title: "Textarea", description: "Style multi-line textareas with labels, helper text, sizing rows, read-only and disabled states, and validation feedback." },
  { path: "/docs/components/icons", sectionId: "icons", category: "Components", title: "Icons", description: "Use Lucide as the recommended icon set with Boobstrap’s current-color sizing utilities." },
  ...
  { path: "/docs/interactivity/command-palette", sectionId: "command-palette", category: "Interactivity", title: "Command palette", description: "Build accessible Cmd+K / Ctrl+K command palettes with live query filtering and keyboard navigation." },
  ...
  { path: "/docs/interactivity/svelte", sectionId: "svelte-adapter", category: "Interactivity", title: "Svelte adapter", description: "Use the official @boobstrap/svelte adapter with Svelte 5 runes, action directives, and 18 headless primitives." },

export const docsPages = [
  ...
  { path: "/docs/components/tables", sectionId: "tables", category: "Components", title: "Tables, pagination, and DataTables", description: "Build semantic data tables with composable styles, responsive overflow, accessible pagination, and a fully themed DataTables 3 integration." },

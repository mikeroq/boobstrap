...
The site imports `@boobstrap/boobstrap@0.1.3` from npm, keeping local development and production builds reproducible while exercising the same public package available to framework users.
